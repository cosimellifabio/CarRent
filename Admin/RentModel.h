...
public:
    ...
    bool getRent(QSqlDatabase db, const QModelIndex& i, int & id, QString& name, QString& brand, QString& tail_number, QString& class1);
    bool selectRent(QSqlDatabase db, int id, QString& name, QString& brand, QString& tail_number, QString& class1);
